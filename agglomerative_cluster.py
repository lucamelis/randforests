...
for i in range(0, num_tests):
    ...
    for n_clusters in clusters_values:
        ...
        estimator = AgglomerativeClustering(n_clusters=n_clusters, 
                                connectivity=connectivity, linkage='average' , affinity='cosine')
...
compute_stats('AggClustering', df_stats)

# save the df for later processing
df_stats.to_pickle("Agglomerative_stats.pkl")